...
// ********** Super Admin Routes *********
    ...
    Route::get('/counties', [SuperAdminController::class, 'counties'])->name('sadmincounties');
    Route::get('/get-subcounties/{countyId}', [SuperAdminController::class, 'getSubcounties'])->name('get-subcounties');
    Route::get('/get-wards',  [SuperAdminController::class,'getWards'])->name('getWards');
    Route::get('/get-areas',  [SuperAdminController::class,'getAreas'])->name('getAreas');
    Route::get('/subcounties', [SuperAdminController::class, 'subcounties'])->name('sadminsubcounties');
    Route::get('/wards', [SuperAdminController::class, 'wards'])->name('sadminwards');
    Route::get('/areas', [SuperAdminController::class, 'areas'])->name('sadminareas');
