...
<link rel="manifest" href="{{ asset('public/assets/img/favicons/manifest.json') }}">
  ...
  <body  style="background:url('/images/city-illuminate-by-sun.jpg') center/cover;">
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center fw-bolder fs-2" href="#">
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#features">Services</a></li>
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#pricing">Career Tips</a></li>
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="/logout">Logout</a></li>
      ...
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(public/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-sm-none" style="background-image:url(public/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 min-vh-md-100">
            <div class="col-md-9 col-lg-6 py-6 text-sm-start text-center">
              <h1 class="mt-6 mb-sm-4 display-2 fw-semi-bold lh-sm fs-4 fs-lg-6 fs-xxl-8"> Welcome  {{ auth()->user()->name }}
Find your service Providers better <br class="d-block d-lg-none d-xl-block" />and faster</h1>
    ...
    <div class="container">
      ...
      <section class="py-0"><img class="w-100" src="public/assets/img/illustrations/come-on-join.png" alt="" />
        <div class="container">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="public/assets/img/gallery/user-2.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="public/assets/img/gallery/user-3.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
