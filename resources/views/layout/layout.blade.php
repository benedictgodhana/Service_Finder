...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Connect_Hub</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <a class="nav-link" href="{{ route('superAdminUsers') }}">
        <i class="bi bi-person fs-4"></i><span>Customers</span>
    </a>
</li>
<li>
    <a class="nav-link" href="{{ route('superAdminDoctors') }}">
        <i class="bi bi-file-earmark-medical fs-4"></i><span>Service Providers</span>
    </a>
</li>
<li>
    <a class="nav-link" href="{{ route('manageRole') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav1" data-bs-toggle="collapse" href="#">
          <i class="bi bi-geo-alt fs-4"></i><span>Location</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a class="nav-link" href="{{ route('sadmincounties') }}">
              <i class="bi bi-geo-alt fs-4"></i><span>Counties</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="{{ route('sadminsubcounties') }}">
              <i class="bi bi-geo-alt fs-4"></i><span>SubCounties</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="{{ route('sadminwards') }}">
              <i class="bi bi-geo-alt fs-4"></i><span>Wards</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="{{ route('sadminareas') }}">
              <i class="bi bi-geo-alt fs-4"></i><span>Areas</span>
          </a>
      </li>
